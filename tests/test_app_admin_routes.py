...
class TestAdminRoutes:
    ...
    def test_get_admins_returns_list(self, client, app_access_headers, sample_admin):
        """Test GET /app-admins/ returns list of admins."""
        response = client.get('/app-admins/', headers=app_access_headers)
    ...
    def test_post_admin_with_valid_data(self, client, app_access_headers):
        ...
        assert response.status_code == 200
        data = json.loads(response.data)
        assert data['data']['email'] == payload['data']['email']

    def test_post_admin_duplicate_email(self, client, app_access_headers, sample_admin):
    ...
    def test_post_admin_missing_username(self, client, app_access_headers):
    ...
    def test_post_admin_missing_email(self, client, app_access_headers):
    ...
    def test_post_admin_missing_password(self, client, app_access_headers):
    ...
    def test_get_admins_without_app_token(self, client, sample_admin):
        """Test GET /app-admins/ without app token returns 401."""
...
class TestSubjectRoutes:
    ...
    def test_post_subjects_with_valid_data(self, client, app_access_headers):
    ...
    def test_post_subjects_invalid_curriculum(self, client, app_access_headers):
    ...
    def test_put_subject_with_valid_data(self, client, app_access_headers, sample_subject):
        """Test PUT /subjects/<id>/ updates subject."""
        payload = {
            "data": {
                "id": sample_subject.id,
                "name": "Updated Math",
                "short_name": "UMath",
                "curriculum": "bece"
            }
    ...
    def test_put_subject_nonexistent_id(self, client, app_access_headers):
    ...
    def test_delete_subject_existing_id(self, client, app_access_headers, sample_subject):
    ...
    def test_delete_subject_nonexistent_id(self, client, app_access_headers):
...
class TestThemeRoutes:
    ...
    def test_post_themes_with_valid_data(self, client, app_access_headers, sample_subject):
    ...
    def test_post_themes_missing_subject_id(self, client, app_access_headers):
    ...
    def test_put_theme_with_valid_data(self, client, app_access_headers, sample_theme, sample_subject):
    ...
    def test_put_theme_nonexistent_id(self, client, app_access_headers, sample_subject):
    ...
    def test_delete_theme_existing_id(self, client, app_access_headers, sample_theme):
    ...
    def test_delete_theme_nonexistent_id(self, client, app_access_headers):
...
class TestTopicRoutes:
    ...
    def test_post_topics_with_valid_data(self, client, app_access_headers, sample_subject, sample_theme):
    ...
    def test_post_topics_missing_subject_id(self, client, app_access_headers, sample_theme):
    ...
    def test_post_topics_missing_theme_id(self, client, app_access_headers, sample_subject):
    ...
    def test_put_topic_with_valid_data(self, client, app_access_headers, sample_topic, sample_subject, sample_theme):
    ...
    def test_put_topic_nonexistent_id(self, client, app_access_headers, sample_subject, sample_theme):
    ...
    def test_delete_topic_existing_id(self, client, app_access_headers, sample_topic):
    ...
    def test_delete_topic_nonexistent_id(self, client, app_access_headers):
