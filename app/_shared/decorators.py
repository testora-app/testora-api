    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            if payload['is_school_suspended']:
                return permissioned_denied("Your school account has been suspended. Please contact your school admin.")
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            if user and user['school_package'] == 'premium':
                return func(*args, **kwargs)
            return permissioned_denied("You need a premium subscription to access this feature.")
        return wrapper
    return decorator
