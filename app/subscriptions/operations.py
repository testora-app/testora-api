...
class SchoolBillingHistoryManager(BaseManager):
    ...
    def get_school_billing_history_by_payment_ref(self, payment_reference: str) -> SchoolBillingHistory:
        return SchoolBillingHistory.query.filter_by(payment_reference=payment_reference, is_deleted=False).first()
