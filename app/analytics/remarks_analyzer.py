...
class RemarksAnalyzer(object):
    ...
    def determine_remarks(score) -> str:
        for percentile, comments in sorted(
            RemarksAnalyzer.get_benchmark_comments().items(), reverse=True
        ):
    ...
    def add_remarks_to_test(new_test, old_test):
        ...
        remark = RemarksAnalyzer.determine_percentage_change(
            new_score, old_score
        ) + RemarksAnalyzer.determine_remarks(new_score)
