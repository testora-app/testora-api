...
class StaffManager(BaseManager):
    def create_staff(self, first_name, surname, email, password,
                     school_id, is_admin=False, is_approved=False, other_names=None) -> Staff:
        new_staff = Staff(
    ...
    def get_staff_by_school(self, school_id) -> List[Staff]:
        return Staff.query.filter_by(school_id=school_id).all()
